...
from open_targets.data.schema import (
    ...
    FieldEvidenceCancerGeneCensusDirectionOnTrait,
    FieldEvidenceCancerGeneCensusDiseaseFromSourceMappedId,
    FieldEvidenceCancerGeneCensusId,
    FieldEvidenceCancerGeneCensusResourceScore,
    FieldEvidenceCancerGeneCensusScore,
    FieldEvidenceCancerGeneCensusStudyId,
    FieldEvidenceCancerGeneCensusTargetFromSourceId,
)
...
node_target_disease_association_cancer_gene_census: Final[AcquisitionDefinition[NodeInfo]] = (
    ExpressionNodeAcquisitionDefinition(
        ...
        primary_id=FieldEvidenceCancerGeneCensusId,
