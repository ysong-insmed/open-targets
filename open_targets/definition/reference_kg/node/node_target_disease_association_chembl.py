...
from open_targets.data.schema import (
    ...
    FieldEvidenceChemblClinicalPhase,
    FieldEvidenceChemblClinicalStatus,
    FieldEvidenceChemblCohortPhenotypes,
    FieldEvidenceChemblDirectionOnTrait,
    FieldEvidenceChemblDiseaseFromSource,
    FieldEvidenceChemblDiseaseFromSourceMappedId,
    FieldEvidenceChemblId,
    FieldEvidenceChemblScore,
    FieldEvidenceChemblStudyId,
    FieldEvidenceChemblStudyStartDate,
    FieldEvidenceChemblStudyStopReason,
    FieldEvidenceChemblStudyStopReasonCategories,
    FieldEvidenceChemblTargetFromSourceId,
)
...
node_target_disease_association_chembl: Final[AcquisitionDefinition[NodeInfo]] = ExpressionNodeAcquisitionDefinition(
    ...
    primary_id=FieldEvidenceChemblId,
