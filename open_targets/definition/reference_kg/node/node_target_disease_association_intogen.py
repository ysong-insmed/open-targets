...
from open_targets.data.schema import (
    ...
    FieldEvidenceIntogenCohortDescription,
    FieldEvidenceIntogenCohortId,
    FieldEvidenceIntogenCohortShortName,
    FieldEvidenceIntogenDirectionOnTrait,
    FieldEvidenceIntogenDiseaseFromSource,
    FieldEvidenceIntogenDiseaseFromSourceMappedId,
    FieldEvidenceIntogenId,
    FieldEvidenceIntogenResourceScore,
    FieldEvidenceIntogenScore,
    FieldEvidenceIntogenSignificantDriverMethods,
    FieldEvidenceIntogenTargetFromSourceId,
)
...
node_target_disease_association_intogen: Final[AcquisitionDefinition[NodeInfo]] = ExpressionNodeAcquisitionDefinition(
    ...
    primary_id=FieldEvidenceIntogenId,
