...
from open_targets.data.schema import (
    ...
    FieldEvidenceUniprotLiteratureConfidence,
    FieldEvidenceUniprotLiteratureDatasourceId,
    FieldEvidenceUniprotLiteratureDiseaseFromSource,
    FieldEvidenceUniprotLiteratureDiseaseFromSourceId,
    FieldEvidenceUniprotLiteratureDiseaseFromSourceMappedId,
    FieldEvidenceUniprotLiteratureId,
    FieldEvidenceUniprotLiteratureScore,
    FieldEvidenceUniprotLiteratureTargetFromSourceId,
    FieldEvidenceUniprotLiteratureTargetModulation,
)
...
node_target_disease_association_uniprot_literature: Final[AcquisitionDefinition[NodeInfo]] = (
    ExpressionNodeAcquisitionDefinition(
        ...
        primary_id=FieldEvidenceUniprotLiteratureId,
