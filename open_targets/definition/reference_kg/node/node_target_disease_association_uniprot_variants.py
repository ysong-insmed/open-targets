...
from open_targets.data.schema import (
    ...
    FieldEvidenceUniprotVariantsConfidence,
    FieldEvidenceUniprotVariantsDatasourceId,
    FieldEvidenceUniprotVariantsDiseaseFromSource,
    FieldEvidenceUniprotVariantsDiseaseFromSourceId,
    FieldEvidenceUniprotVariantsDiseaseFromSourceMappedId,
    FieldEvidenceUniprotVariantsId,
    FieldEvidenceUniprotVariantsScore,
    FieldEvidenceUniprotVariantsTargetFromSourceId,
    FieldEvidenceUniprotVariantsTargetModulation,
    FieldEvidenceUniprotVariantsVariantId,
    FieldEvidenceUniprotVariantsVariantRsId,
)
...
node_target_disease_association_uniprot_variants: Final[AcquisitionDefinition[NodeInfo]] = (
    ExpressionNodeAcquisitionDefinition(
        ...
        primary_id=FieldEvidenceUniprotVariantsId,
